...
public class ContactsSyncAdapterService extends Service
{
	...
	private static void addContact(Account account, String xingId, String name)
	{
		...
		// "vnd.android.cursor.item/vnd.com.tandogan.android.xingsync.profile"
		// to display a link to the Xing profile
		// TODO replace profile name with resource lookup
		builder = ContentProviderOperation.newInsert(ContactsContract.Data.CONTENT_URI);
		builder.withValueBackReference(ContactsContract.Data.RAW_CONTACT_ID, 0);
		builder.withValue(ContactsContract.Data.MIMETYPE, "vnd.android.cursor.item/vnd.com.tandogan.android.xingsync.profile");
